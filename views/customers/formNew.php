<div class="modal fade" id="customers-new-dialog" tabindex="-1" role="dialog" aria-labelledby="newClientTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newClientTitle">Nuevo Cliente</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" style="width: 100px;" onclick="$('#reg-cliente').submit();">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $.validator.setDefaults({
        submitHandler: function () {
            saveRecord('customers','add','reg-cliente');
        }
    });
