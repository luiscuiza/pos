...
<div class="modal fade" id="users-edit-dialog" tabindex="-1" role="dialog" aria-labelledby="editUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" style="width: 100px;" onclick="$('#edit-usuario').submit();">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $.validator.setDefaults({
        submitHandler: function () {
            saveRecord('users','edit','edit-usuario');
        }
    });
